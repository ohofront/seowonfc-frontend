...
import AdminSponsorApplicationsPage from './pages/AdminSponsorApplicationsPage';

export default function App(){return <Routes><Route element={<Layout/>}><Route index element={<HomePage/>}/><Route path="login" element={<LoginPage/>}/><Route path="signup" element={<SignupPage/>}/><Route path="news" element={<NewsListPage/>}/><Route path="news/:id" element={<NewsDetailPage/>}/><Route path="players" element={<PlayersPage/>}/><Route path="players/:id" element={<PlayerDetailPage/>}/><Route path="matches" element={<MatchesPage/>}/><Route path="standings" element={<StandingsPage/>}/><Route path="sponsors" element={<SponsorsPage/>}/><Route path="sponsors/apply" element={<SponsorApplicationPage/>}/><Route element={<ProtectedRoute/>}><Route path="boards/:boardType" element={<BoardListPage/>}/><Route path="boards/:boardType/:postId" element={<PostDetailPage/>}/><Route path="boards/:boardType/write" element={<PostWritePage/>}/><Route path="events" element={<EventsPage/>}/><Route path="events/:id" element={<EventDetailPage/>}/><Route path="mypage" element={<MyPage/>}/><Route path="players/apply" element={<PlayerApplicationPage/>}/><Route path="players/my-applications" element={<MyPlayerApplicationsPage/>}/></Route><Route element={<ProtectedRoute admin/>}><Route path="admin" element={<AdminPage/>}/><Route path="admin/player-applications" element={<AdminPlayerApplicationsPage/>}/><Route path="admin/sponsor-applications" element={<AdminSponsorApplicationsPage/>}/></Route><Route path="*" element={<NotFound/>}/></Route></Routes>}
